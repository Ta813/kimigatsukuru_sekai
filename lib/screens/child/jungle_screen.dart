...
class JungleScreen extends StatefulWidget {
  ...
  @override
  State<JungleScreen> createState() => _JungleScreenState();
}
...
class _JungleScreenState extends State<JungleScreen> {
  ...
  void initState() {
    super.initState();
    SharedPrefsHelper.setHasVisitedJungle(true);
    _loadPlacedItems();
  }
  ...
  Future<void> _loadPlacedItems() async {
    ...
    // 全てのアイテムのパスを結合
    final allItems = [...jungleItems, ...jungleLivings];
          ...
          RepaintBoundary(
            ...
            child: Stack(
              children: [
                ...
                ..._equippedJungleItems.map((itemPath) {
                ...
                ..._equippedJungleLivings.map((itemPath) {
                  return DraggableCharacter(
                    id: itemPath,
                    imagePath: itemPath,
                    position:
                ...
                ..._equippedCharacters.map((charPath) {
                  return DraggableCharacter(
                    id: 'jungle_$charPath', // IDとして画像パスを使う
                    imagePath: charPath,
                    position:
